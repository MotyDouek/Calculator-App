...
class MainActivity : AppCompatActivity() {
    ...
    // lateinit = will be init later. it is a safe null.
    ...
    private fun preformOperation (value: Double, operation: String)
    {
        if(operand1 == null) {
            ...
            when(pendingOperation)
            {
                ...
                "/" -> operand1 = if (value == 0.0) {
                    ...
                    operand1!! / value //!! asserts that an expression is non-null
                }
        ...
        newNumber.setText("") //empty the newNumber screen
    }
